...
namespace lilac {
    ...
    class LILAC_DLL CustomLoader : public Mod {
        protected:
             ...
             * this CustomLoader as a dependency
             * is loaded.
