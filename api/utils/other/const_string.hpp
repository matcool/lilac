...
namespace lilac::utils {
    ...
    template <std::string_view const& Separator, std::string_view const&... Strs>
    static constexpr auto const_join_sep = const_string_join<Separator, Strs...>::value;

    template <std::string_view const&... Strs>
    static constexpr auto const_join = const_string_join<sv_none, Strs...>::value;

    template <std::string_view const&... Strs>
    static constexpr auto const_join_path = const_string_join<
        sv_path, Strs...
    >::value;
    
    template <std::string_view const& Separator, std::string_view const&... Strs>
    static constexpr const char* const_join_sep_c_str = const_string_join<
        Separator, Strs...
    >::value.data();

    template <std::string_view const&... Strs>
    static constexpr const char* const_join_c_str = const_string_join<
        sv_none, Strs...
    >::value.data();

    template <std::string_view const&... Strs>
    static constexpr const char* const_join_path_c_str = const_string_join<
        sv_path, Strs...
    >::value.data();
}
